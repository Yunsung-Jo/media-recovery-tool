...
└── completed/
    └── 2026/
        ...
        └── T-0005-existing-engine-responsibility-split.md
```
...
| [T-0005](completed/2026/T-0005-existing-engine-responsibility-split.md) | 기존 복구 엔진의 동작 보존 책임 분리 |
...
현재 활성 Task는 없다. 다음 계획 작업은 T-0006이다.
