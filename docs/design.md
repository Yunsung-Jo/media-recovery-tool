...
| [`domain/objects.py`](../src/media_recovery/domain/objects.py) | 파일 종류·offset과 탐지 근거 `source`·`confidence`·`scan_start`를 담는 불변 `FileHit` |
...
[evaluation.md](evaluation.md)를 본다.
