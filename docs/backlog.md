...
- **의존:** ~~W2 이후~~ **전제 충족(2026-07-03)** — 임계 비례화가 이식돼 소형·중형도 재동기가 수락된다. 남은 FAILED 15건 중 11건(96×72 DHT군 10 + 50×50 1)이 이 작업의 직접 대상(0xB164690C 실측: 자체 DHT로는 run≥20 후보 전무 — 이식 없인 W2로도 불가).
